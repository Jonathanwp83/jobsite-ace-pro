...
import { Users, CreditCard, MessageSquare, TrendingUp, DollarSign, UserCheck } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">All registered contractors</p>
        </CardContent>
      </Card>
